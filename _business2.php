    ...
    <body>
        <main>
            ...
            <section class="section-promote">
                    <h3 class="view__header">The Business of Options</h3>
                    <div class="row">
                                ...
                                <div class="promotecard__side promotecard__side--front">
                                 ...
                                 <div class="promotecard__side promotecard__side--back promotecard__side--back-4">
                                    <div class="promotecard__cta">
                                        ...
                                        and explain things to me that I didn’t understand. I picked out the  
                                        </p>
                                    </div> 
                                </div>
                            </div>
                            ...
                            <div class="promotecard">
                                <div class="promotecard__side promotecard__side--front">
                                    <div class="promotecard__text promotecard__text--5">
                                        ...
                                        <h3 class="heading-tertiary-small">PART ONE:</h3>
                                        1 – What is an option?
                                ...
                                <div class="promotecard__side promotecard__side--back promotecard__side--back-5">
                                    ...
                                    Granting a producer an option means granting them the exclusive right to develop the script… to try to raise the money to 
                                    ...
                                    Getting optioned is exciting. But it doesn’t mean your film is going to get made… it means someone wants to make your film but doesn’t have the resources yet. 
                                    If they did have the resources, they’d buy it and make it, right? 
                                    </p>
                                    </div> 
                                </div>
                            </div>
                            ...
                            <div class="promotecard">
                                <div class="promotecard__side promotecard__side--front">
                                    <div class="promotecard__text promotecard__text--6">
                                        ...
                                        right?) may be more valuable to them than they 
                                        </p>
                                    </div>
                                ...
                                <div class="promotecard__side promotecard__side--back promotecard__side--back-6">
                                    <div class="promotecard__cta">
                                        <p>
                                        are to you. Your script may no longer be 
                                        working for you, either inside or out of the option. (But you don’t have to say no. 
                                        There may be good reasons to 
                                        take said chance with Mister unknown resourceless producer… more on that later.)</br>
                                        4 – Get a lawyer
                                        ...
                                        that you didn’t know existed. And you will be better off for it. Second, partner with your lawyer.
                            ...
                            <div class="promotecard">
                                <div class="promotecard__side promotecard__side--front">
                                    <div class="promotecard__text promotecard__text--1">
                                        <p>
                                         I’ve heard people complain long and hard about how their lawyers 
                                        ...
                                        (and it pretty much was), and it ran its course. When the producer wanted to 
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="promotecard">
                                <div class="promotecard__side promotecard__side--front">
                                    <div class="promotecard__text promotecard__text--2">
                                        ...
                                        Your script is Intellectual Property (IP), and he with the
                                        </p>
                                    </div>
                                    <!-- <h4 class="promotecard__head">
                                        <span class="promotecard__head-span promotecard__head-span--2">Articles include:</span>    
                                ...
                                <div class="promotecard__side promotecard__side--back promotecard__side--back-2">
                                    <div class="promotecard__cta">
                                    <p>
                                      best IP wins. No script, no movie. 
                                    ...
                                    When you option the script to a producer, you’re transferring your rights in the IP to that producer 
                                    </p>
                                    </div> 
                                </div>
                            </div>
                            ...
                            <div class="promotecard">
                                <div class="promotecard__side promotecard__side--front">
                                    <div class="promotecard__text promotecard__text--3">
                                        <p> 
                                    to use as her own. It’s no longer yours for the period of the option… it’s now an asset in the producer’s
                                    ...
                                    Because you’re giving up an asset with value and taking it off the market, you should be compensated. </br>
                                ...
                                <div class="promotecard__side promotecard__side--back promotecard__side--back-3">
                                    <div class="promotecard__cta">
                                        <p>
                                        The option price is what you get for giving the producer rights to your IP, and taking it off the market. 
                                    ...
                                    say the purchase is 50K, and you’ve received 5K as the option price (10%).
                                        </p>
                                    </div> 
                                </div>
                            </div>
                        ...
                        <div class="col-1-of-3">
                            <div class="promotecard">
                                <div class="promotecard__side promotecard__side--front">
                                    <div class="promotecard__text promotecard__text--4">
                                        <p>
                                        When they exercise, they’ll give you the other 45K. Should they never exercise, you keep the 5K as compensation 
                                        ...
                                        One rule of thumb says the script should account for about 3% of the budget… 
                                        </p>
                                    </div>
                                </div>
                                 <div class="promotecard__side promotecard__side--back promotecard__side--back-4">
                                    <div class="promotecard__cta">
                                        <p>  
                                        so if your script is a little indie 
                                        ...
                                        little backend piece of Paranormal Activity? </br>
                                        ...
                                        The producer may ask you to option your script to them
                                        </p>
                                    </div> 
                                </div>
                            </div>
                        ...
                        <div class="col-1-of-3">
                            <div class="promotecard">
                                <div class="promotecard__side promotecard__side--front">
                                    <div class="promotecard__text promotecard__text--5">
                                        <p>
                                         for very little or no money, and while many writers may disagree with me, I don’t think that’s 
                                        ...
                                        In addition to your purchase price, consider negotiating for other  
                                        </p>
                                    </div>
                                    <!-- <h4 class="promotecard__head">
                                        <span class="promotecard__head-span promotecard__head-span--2">Articles include:</span>    
                                ...
                                <div class="promotecard__side promotecard__side--back promotecard__side--back-5">
                                    <div class="promotecard__cta">
                                    <p>
                                        compensations, like backend points, or a higher purchase price, 
                            ...
                            <div class="promotecard">
                                ...
                                <div class="promotecard__side promotecard__side--back promotecard__side--back-6">
                                    <div class="promotecard__cta">
                                        ...
                                        don’t add flying corncobs for simply no reason, do they?
                        ...
                        <div class="col-1-of-3">
                            <div class="promotecard">
                                <div class="promotecard__side promotecard__side--front">
                                    <div class="promotecard__text promotecard__text--1">
                                        <p>
                                        Don’t be married to your script. Filmmaking is a collaborative artform, and your option makes you a part of a team. If you’re so in love with 
                                        ...
                                        and maybe (just maybe) you’ll like the experience. 
                                        </p>
                                    </div>
                                </div>
                                 <div class="promotecard__side promotecard__side--back promotecard__side--back-4">
                                    <div class="promotecard__cta">
                                        <p>  
                                        Maybe, just maybe, you’ll end up sharing credit with a writer of note. And that’s not a bad thing.
                        ...
                        <div class="col-1-of-3">
                            <div class="promotecard">
                                <div class="promotecard__side promotecard__side--front">
                                    <div class="promotecard__text promotecard__text--2">
                                        <p>
                                         Otherwise, you’ve got your script back, but the producer potentially still has rights to their 
                                        version… and now you’re in 
                                        competition with another version of your script that you don’t control. That’s not a place you want to be.</br>
                                        10 – So why option?
                                        ...
                                        Movies go in and out of production like fashion and fads. The option lets you and the   
                                        </p>
                                    </div>
                                    <!-- <h4 class="promotecard__head">
                                        <span class="promotecard__head-span promotecard__head-span--2">Articles include:</span>    
                                ...
                                <div class="promotecard__side promotecard__side--back promotecard__side--back-2">
                                    <div class="promotecard__cta">
                                    <p>
                                        producer partner together with limited liability and
                                        ...
                                        The option is a great opportunity to learn more about the business, to meet new people,
                                    </p>
                                    </div> 
                                </div>
                            </div>
                        ...
                        <div class="col-1-of-3">
                            <div class="promotecard">
                                <div class="promotecard__side promotecard__side--front">
                                    <div class="promotecard__text promotecard__text--3">
                                        <p>
                                        and make new connections. Take full advantage of it (as much as the producer will allow) 
                                        ...
                                        and showing yourself to be a professional who delivers and is willing to work and play well with others. You’re in her rolodex, and maybe she’ll refer you to her pals.
                                ...
                                <div class="promotecard__side promotecard__side--back promotecard__side--back-3">
                                    <div class="promotecard__cta">
                                        <p>
                                        That may just prove to be payment enough,
                                        when it leads to your next big deal.
                                        <h3 class="heading-tertiary-small">About Chip Street</h3>
                                        Chip's first screenplay, Rocket Summer sold to eKidsFilms and the novelization is now available on Amazon.com. His second script, Grampa Was A Superhero, was promptly optioned 
                                        ...
                                        judge, and founded Write Club Screenplay Challenge, which launches quarterly micro-screenplay contests (when he has time). 
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="section-promote--2">
                    <p class="view__paragraph" Id="view__me">
                    Chip's screenwriting and crowdfunding articles have been 
                    referenced by Script Magazine, the BlueCat Newsletter, IndieWire, JohnAugust.com, Bleeding Cool, and No Film School.
                    </p>


                    <!-- <p class="view__paragraph">In the following article the author refers to options of screenplays. The same discussions are relative to the 
                        principals and rules that apply for options of reality programming. Keep in mind the processes are norms in the industry and the services 
                        of an attorney should be  considered  when negotiating and signing contracts. 
                    A producer wants to option your script. Should you do it? What are the considerations?
                    Now that I’ve been through the option gauntlet a couple of times, I get asked about the experience and the process. It’s a little humbling, 
                    cuz I’m just a lucky guy with a couple of options, but I know how much I appreciate when I stumble across some good first-hand info, and figured  -->
                    <!-- it would be a good idea to share what I know. So I thought I’d gather my notes together here, in the hopes that it’ll prove useful to others. 
                    This is no substitute for having an attorney, mind you… more on that later. But I wish I’d had this list.
                    Of course, I’m no lawyer, but I did pay one (a really good one, too!) to represent me in my deals. I wanted to learn, so I was involved in the 
                    negotiation process, and reviewed each round of revisions on the offers and eventual contracts, asked lots of questions, and took lots of notes. 
                    I asked the attorney to mark up the contract with all the items of concern or negotiation he could think of… then I had him go over them with me, 
                    and explain things to me that I didn’t understand. I picked out the points I wanted to ask for, and removed items I felt were over-reaching or 
                    I just didn’t feel like I needed. -->
                    <!-- I don’t plan on being so involved in future deals. But now that I’ve got a handle on the basic vocabulary and have some sense of what it is I 
                    should be looking for, at least I won’t feel like an outsider in my own negotiations.
                    Part I is the basics… what is an option, how to respond, and what to expect. Part II is a list of negotiation points and terms that I’m very glad 
                    I know about now, and you might like to know about as well. -->
                    </p>
                    <!-- <h3 class="heading-tertiary-small">PART ONE:</h3>
                    1 – What is an option?
                    Producer Bob stumbled across your script on your site or in a screenplay competition, and has approached you with an offer to “option” it. What’s that mean, exactly?
