...
if(isset($_GET['id']) && isset($_GET['firstname']) && isset($_GET['email'])){
    $id = $_GET['id']; $firstname=$_GET['firstname']; $email = $_GET['email'];
    mysqli_query($link,"INSERT INTO `realtv_log`(`firstname`, `username`, `page`) VALUES ('$firstname','$email','testMovieView')");
        ...
        <div class="d-flex justify-content-center mb-4">
            <div class="row">                           
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 mt-3 text-center">
                    ...
                    <a href="contestant_signup.php?id=<?= $movie_data['id'] ?>&price=<?= $movie_data['reg_fee'] ?>&firstname=<?=$firstname?>&email=<?= $email ?>" class="btn btn-warning mt-2">EZ $<?= $movie_data['reg_fee'] ?? "55" ?> to Register</a>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 mt-3 text-center">
                    <img src="img/uploads/<?= mysqli_fetch_object($pic_query)->movie_pic ?>" width="100%">
                </div>
