...
$query = mysqli_query($link, "Select * from realtv_executives");
...
if($step == "view_profile"){
    ...
    $writer = mysqli_fetch_assoc(mysqli_query($link, "Select * from realtv_executives where unique_id = '$profileId'"));
}
?>
...
<div class="row my-4">
        ...
        <div class="nav nav-tabs text-center mx-auto" id="v-pills-tab" role="tablist">
            <a class="nav-link <?= $step == 'all' ? 'tab-active' : '' ?>" href="?step=all">All Executives</a>
            <?php if($step == 'view_profile'): ?>
            <a class="nav-link <?= $step == 'view_profile' ? 'tab-active' : '' ?>" href="?step=resume">Executive's Profile</a>
            <?php endif; ?>
        </div>
            ...
            <table class="stripe compact hover table cell-border" id="contestants">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center"><a class="badge badge-warning" href="<?= $cont['company_id'] != "" ? 'company_details.php?id=' . $cont['company_id'] : ''; ?>" target="_blank">View</a></td>
